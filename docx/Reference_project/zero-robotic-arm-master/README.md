...
<img src="./4. Other/Images/zyarm-x1-render.jpg" width="620" height="350">

第二代桌面机械臂 **ZYArm-X1** 已正式发布，拥有 6+1 轴自由度，采用高质量总线舵机驱动，整机质量大幅降低，灵活度显著提升，非常适合教学、创客项目、比赛任务以及具身智能实验，尤其适合零基础初学者使用。机械臂本体以售卖形式提供，配套 开源代码仓库 覆盖固件、串口协议、Python/C++ SDK、Web 可视化、ROS 2、MoveIt、Gazebo、LeRobot、示例程序、诊断工具及系统化文档。

ZYArm-X1 既不是只停留在演示层的封闭玩具，也不是一开始就要求配置复杂机器人栈的科研平台。你可以从最小串口命令开始，让真实机械臂安全动起来，再逐步探索 SDK 控制、Web 控制与仿真、ROS 2 运动规划、LeRobot 遥操、数据采集、回放与策略评估。

仓库链接：

GitHub: https://github.com/ZYAI-Robot/ZYArm-X1

Gitee: https://gitee.com/ZYAI-Robot/zyarm-x1

宣传视频: https://www.bilibili.com/video/BV1n6RQBJE9n/?spm_id_from=333.337.search-card.all.click


### 交流群
欢迎大家加入我们的技术交流群！🤖  
QQ群：1041684044（已扩充 2000 人，快冲！）   
QQ2群：1029351597